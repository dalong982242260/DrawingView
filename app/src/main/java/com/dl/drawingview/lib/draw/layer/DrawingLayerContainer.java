package com.dl.drawingview.lib.draw.layer;
...
import com.dl.drawingview.lib.draw.util.RotationGestureDetector;
    ...
    private class GestureListener implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
        ...
        public boolean onDown(MotionEvent e) {
            ...
            if (self.getGestureView() != null) {
                LayoutParams layoutParams = (LayoutParams) getGestureView().getLayoutParams();
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2,
            ...
            if (self.getGestureView() != null
                ...
                LayoutParams layoutParams = (LayoutParams) self.getGestureView().getLayoutParams();
