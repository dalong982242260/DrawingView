package com.dl.drawingview.lib.draw;
...
import com.dl.drawingview.lib.draw.layer.DrawingLayerBaseView;
import com.dl.drawingview.lib.draw.layer.DrawingLayerContainer;
import com.dl.drawingview.lib.draw.layer.DrawingLayerImageView;
import com.dl.drawingview.lib.draw.layer.DrawingLayerTextView;
import com.dl.drawingview.lib.draw.layer.DrawingLayerViewProtocol;
import com.dl.drawingview.lib.draw.model.DrawingData;
...
import com.dl.drawingview.lib.draw.util.DrawingAnimationView;
...
public class DrawingView extends RelativeLayout implements View.OnLayoutChangeListener, DrawingLayerTextView.TextChangeDelegate {
    ...
    public final static int ACTION_DRAW = 100;
    public final static int ACTION_REDO = 101;
    public final static int ACTION_UNDO = 102;
    ...
    public void refreshWithDrawingData(DrawingData data) {
        ...
        getUndoRedoStateDelegate().onUndoRedoStateChange(ACTION_DRAW, this, getDrawingData().canUndo(), getDrawingData().canRedo());
    }
     ...
     *                       因为绘制数据中不宜保存背景drawable，故存储唯一标识id，在重绘时通过回调向外部通过id获取对应的背景drawable
     */
    ...
    public boolean undo() {
        ...
        if (canUndo()) {
            ...
            getUndoRedoStateDelegate().onUndoRedoStateChange(ACTION_UNDO, this, getDrawingData().canUndo(), getDrawingData().canRedo());
    ...
    public boolean redo() {
        ...
        if (canRedo()) {
            ...
            getUndoRedoStateDelegate().onUndoRedoStateChange(ACTION_REDO,
                    this, getDrawingData().canUndo(), getDrawingData().canRedo());
    ...
    public interface UndoRedoStateDelegate {
         ...
         */
        void onUndoRedoStateChange(int state, DrawingView drawingView, boolean canUndo, boolean canRedo);
    }
    ...
    public DrawingLayerBaseView getBaseLayerImageView() {
        if (this.baseLayerImageView == null) {
            ...
            this.baseLayerImageView.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    public DrawingLayerContainer getLayerContainer() {
        if (this.layerContainer == null) {
            ...
            this.layerContainer.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    public DrawingAnimationView getAnimationView() {
        if (this.animationView == null) {
            ...
            this.animationView.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        }
