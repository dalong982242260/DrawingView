package com.dl.drawingview.lib.draw.model;
...
import com.dl.drawingview.lib.draw.helper.json.JsonModel;
import com.dl.drawingview.lib.draw.helper.json.JsonModelProtocol;
...
public class DrawingStep extends JsonModel {
     ...
     * 当前step记录的绘制路径
     */
    @JsonModelProtocol.JsonKey("DP")
    private DrawingPath drawingPath;
    public DrawingStep setDrawingPath(DrawingPath drawingPath) {
